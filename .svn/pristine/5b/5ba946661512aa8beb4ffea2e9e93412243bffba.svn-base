...
void apply_perm(int *arr, int* perm, int length);
...
void ps(char *path, int extended_action1, char *parent_id, int extended_action2)
{
	...
	{
		apply_perm(thread_num_arr, perm, size_contents);
		apply_perm(file_num_arr, perm, size_contents);
		// Print results.
