...
void ps(char *path, int extended_action, char *parent_id)
{
    ...
    int parent_ids_list_size = 0;
    int *parent_ids_list = (int*)calloc(++parent_ids_list_size, sizeof(int));
    			...
    			char *name = sub_dir_ptr->d_name;
					...
					buff_index += 5;
 					...
 					if(extended_action)
 					{
 						...
 						parent_ids_list = (int*)realloc(parent_ids_list, ++parent_ids_list_size);
 						parent_ids_list[parent_ids_list_size - 1] = atoi(pid);
 					}
